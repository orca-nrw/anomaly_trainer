import{html,render}from"../libs/lit/lit.min.js";export{render};export function main(app,table){const cols=table.shift();return html`
    <header>
    ...
    `:""}
  `}export function inputs(app,inputs,solutions){return html`
